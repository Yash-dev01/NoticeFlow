      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-sm text-slate-500 mt-2">
            {initialValues ? "Update the notice details below" : "Fill in the details to create a new notice"}
          </p>
        </div>
                ...
                >
                  {imagePreview ? (
                    ...
                    <div className="flex flex-col items-center">
                      <svg className="w-12 h-12 text-slate-400 group-hover:text-blue-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
